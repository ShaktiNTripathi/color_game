                ...
                var X = n(9669),
                    ...
                    _ = {
                        ...
                        beforeCreate: function () {
                            q()
                                .get("https://mohammadfarmanali.com/9987/src/api/bet.php?action=verifytoken&user=" + localStorage.getItem("username"), {
                        ...
                        methods: {
                            ...
                            getUserdetails() {
                                (this.username = localStorage.getItem("username")),
                                    q()
                                        .get("https://mohammadfarmanali.com/9987/src/api/bet.php?action=getuserinfo&user=" + this.username, { headers: { Authorization: `Bearer ${this.secretKey}` } })
                                        .then((A) => {
